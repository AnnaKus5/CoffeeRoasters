export default function Quality() {
    return (
        <div className="relative bg-navyBlue mx-6 mb-32 rounded-[10px] h-[509px] xmd:mx-20 xmd:grid xmd:grid-cols-2">
            <img className="absolute -top-[78px] left-0 right-0 mx-auto rounded-lg w-[279px] sm:hidden" src="../images/about/mobile/image-quality.jpg" />
            <img className="absolute hidden sm:block -top-40 left-0 right-0 mx-auto rounded-lg xmd:hidden" src="../images/about/tablet/image-quality.jpg" />
            <img className="absolute hidden rounded-lg xmd:block xmd:-top-[88px] xmd:right-[85px]" src="../images/about/desktop/image-quality.jpg" alt="" />
