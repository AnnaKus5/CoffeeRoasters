...
export default function ProductsContainer() {
    ...
    return (
        <section className="mx-auto sm:relative sm:mx-10 md:pt-10">
            ...
            <h2 className="mb-3 font-serif text-text5xl leading-[72px] text-grey text-center sm:opacity-50 sm:text-text7xl sm:mb-6 md:text-[80px] xmd:text-[120px] lg:text-text10xl md:leading-none md:mx-10" style={gradientStyles}>our collection</h2>
            
            <div className="sm:relative sm:-top-[50px] xmd:-top-14 xmd:flex xmd:justify-center ">
